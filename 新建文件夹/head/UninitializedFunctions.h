#ifndef UNINITIALIZEDFUNCTIONAL_H
#define UNINITIALIZEDFUNCTIONAL_H
...
namespace MySTL {
	...
	ForwardIterator uninitialized_copy(InputIterator first, InputIterator last, ForwardIterator result) {
		typedef typename _type_traits<InputIterator>::is_POD_type isPODType;
...
#endif // !UNINITIALIZEDFUNCTIONAL_H
