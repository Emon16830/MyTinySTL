...
namespace MySTL {
	...
	public:
		template <class ELEM>
		friend bool operator == (const reverse_iterator_t<ELEM>& lhs,
			const reverse_iterator_t<ELEM>& rhs);
		template <class ELEM>
		friend bool operator != (const reverse_iterator_t<ELEM>& lhs,
			const reverse_iterator_t<ELEM>& rhs);
		template <class ELEM>
		...
		template <class ELEM>
		friend reverse_iterator_t<ELEM> operator + (
			typename reverse_iterator_t<ELEM>::difference_type n,
			const reverse_iterator_t<ELEM>& rev_it);
		template <class ELEM>
		friend typename reverse_iterator_t<ELEM>::difference_type operator- (
			const reverse_iterator_t<ELEM>& lhs,
			const reverse_iterator_t<ELEM>& rhs);
